                    ...
                    >
                      ...
                      {hoveredCandle === candle.id && (
                        <g>
                          <rect
                            x={x - 50}
                            y={Math.max(4, Math.min(highY, bodyTop) - 85)}
                            width="100"
                            height="80"
                            fill="#1e293b"
                            stroke="#475569"
                          ...
                          <text
                            x={x}
                            y={Math.max(4, Math.min(highY, bodyTop) - 85) + 14}
                            textAnchor="middle"
                            fill="#cbd5e1"
                            fontSize="9"
                            fontWeight="600"
                          ...
                          <text
                            x={x}
                            y={Math.max(4, Math.min(highY, bodyTop) - 85) + 28}
                            textAnchor="middle"
                            fill={isGainCandle ? "#10b981" : "#ef4444"}
                            fontSize="9"
                            fontWeight="700"
                          >
                          ...
                          {candle.approvalStatus && (
                            <text
                              x={x}
                              y={
                                Math.max(4, Math.min(highY, bodyTop) - 85) + 42
                              }
                              textAnchor="middle"
                              fill="#64748b"
                              fontSize="8"
                          ...
                          <text
                            x={x}
                            y={Math.max(4, Math.min(highY, bodyTop) - 85) + 57}
                            textAnchor="middle"
                            fill="#94a3b8"
                            fontSize="8"
                          >
                            O: {candle.open.toFixed(1)} C:{" "}
                            {candle.close.toFixed(1)}
                          </text>
                          <text
                            x={x}
                            y={Math.max(4, Math.min(highY, bodyTop) - 85) + 70}
                            textAnchor="middle"
                            fill="#94a3b8"
                            fontSize="8"
                          >
