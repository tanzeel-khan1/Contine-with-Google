          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
            ...
            >
              ...
              <p className="text-purple-700 leading-relaxed mb-4">
                ...
                academic excellence and character development. We provide a
                safe, supportive, and inspiring environment.
              </p>
              <p className="text-purple-700 leading-relaxed">
                With experienced teachers and modern teaching methods, we
                nurture confidence, creativity, and discipline in every student.
              </p>
            </motion.div>
